...
def do ( alarmsSource, numalarms, startalarmid, minscore, minalt, maxImages ):
    logging.info('do({},{},{},{},{})'.format(numalarms, startalarmid, minscore, minalt, maxImages))
    ...
    #logging.info('Filtering top %d based on score' % maxImages)
    #alarms = alarms[0:maxImages]
...
def main():
    ...
    parser.add_argument('--tlog', default = '')
    parser.add_argument('--minalt', type=int, default = 50)
    parser.add_argument('--maximages', '-i', type=int, default  = -1)
    ...
    #copyAlarms(AlarmServer ( args.svr, args.camera ), AlarmFileSystem(args.camera), args.numalarms, args.startalarmid, args.minscore, args.minalt, args.maximages)
    
    copyImages(AlarmServer ( args.svr, args.camera ), AlarmFileSystem(args.camera), args.tlog, args.maximages)
    # An example of copying
    #copyAlarms(AlarmServer ( "10.0.0.1", "flycam" ), AlarmFileSystem ( 'flycam20140904' ), args.numalarms, args.startalarmid, args.minscore, args.minalt, args.maximages)
    ...
    #do(AlarmFileSystem(args.camera), args.numalarms, args.startalarmid, args.minscore, args.minalt, args.maximages)
    #do(AlarmServer ( args.svr, args.camera ), args.numalarms, args.startalarmid, args.minscore, args.minalt, args.maximages)
